...
const Login = () => {
  return (
    <section className="flex border-2 border-gray-700 shadow-2xl drop-shadow-2xl rounded-xl p-2 w-full md:w-1/2 md:mx-auto h-full mt-24 justify-center items-center">
